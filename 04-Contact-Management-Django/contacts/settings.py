...
INSTALLED_APPS = [
    ...
    'app',
    # 'crispy_forms',  # Temporarily disabled to fix dependency issues
    # 'import_export',  # Temporarily disabled to fix dependency issues
]
...
# Crispy forms (commented out as we've disabled the app)
